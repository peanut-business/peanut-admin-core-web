      ...
      return () =>
        h(
          'section',
          {
            'class': [
              'pa-state',
              `pa-state--${name.replace(/State$/, '').toLowerCase()}`,
            ],
            'data-state': state,
            'role': 'status',
            'aria-live': 'polite',
          ...
          [
            ...
            props.retryAfter === null
              ...
              : h(
                  'p',
                  { class: 'pa-state__retry-after' },
                  `Retry after: ${props.retryAfter}`
                ),
            slots.default?.(),
...
export const ForbiddenState = createStateComponent(
  'ForbiddenState',
  'forbidden',
  {
    title: 'Access denied',
...
export const NotFoundState = createStateComponent(
  'NotFoundState',
  'not-found',
  {
    title: 'Not found',
...
export const ModuleUnavailableState = createStateComponent(
...
export const RateLimitState = createStateComponent(
  'RateLimitState',
  'rate-limit',
  {
...
export const ServiceUnavailableState = createStateComponent(
...
export const SessionExpiredState = createStateComponent(
  'SessionExpiredState',
  'session-expired',
  {
