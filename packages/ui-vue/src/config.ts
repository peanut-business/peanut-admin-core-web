...
export const defineShellHostConfig = (
  ...
  const platformInput = assertObject(
    audiencesInput.platform,
    'audiences.platform'
  );
  ...
  const commands = Object.freeze({
    switchTenantLabel: displayValue(
      commandsInput.switchTenantLabel,
      'commands.switchTenantLabel',
      80
    ),
    logoutLabel: displayValue(
      commandsInput.logoutLabel,
